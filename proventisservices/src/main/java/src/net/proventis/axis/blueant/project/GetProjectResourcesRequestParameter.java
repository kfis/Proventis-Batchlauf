...
/**
 * GetProjectResourcesRequestParameter.java
 *
 ...
 */
            ...
            /**
            *  GetProjectResourcesRequestParameter bean class
            */
        
        public  class GetProjectResourcesRequestParameter
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://project.blueant.axis.proventis.net/",
                "getProjectResourcesRequestParameter",
                "ns8");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected net.proventis.axis.blueant.project.ProjectResourceReleaseType localReleaseType ;
                                

                           /**
                           * Auto generated getter method
                           * @return net.proventis.axis.blueant.project.ProjectResourceReleaseType
                           */
                           public  net.proventis.axis.blueant.project.ProjectResourceReleaseType getReleaseType(){
                            ...
                            /**
                               ...
                               */
                               public void setReleaseType(net.proventis.axis.blueant.project.ProjectResourceReleaseType param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetProjectResourcesRequestParameter.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getProjectResourcesRequestParameter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getProjectResourcesRequestParameter",
                                   ...
                                   xmlWriter.writeEndElement();
                                           ...
                                           localProjectID.serialize(new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","projectID"),
                                            ...
                                            if (localReleaseType==null){
                                                 throw new org.apache.axis2.databinding.ADBException("releaseType cannot be null!!");
                                            }
                                           localReleaseType.serialize(new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","releaseType"),
                                               factory,xmlWriter);
                                    ...
                                    if (localPersonID==null){
                                     ...
                                     localPersonID.serialize(new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","personID"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/",
                                    ...
                                    elementList.add(localReleaseType);
    ...
    public static class Factory{
        ...
        */
        public static GetProjectResourcesRequestParameter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetProjectResourcesRequestParameter object =
                new GetProjectResourcesRequestParameter();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getProjectResourcesRequestParameter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetProjectResourcesRequestParameter)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","releaseType").equals(reader.getName())){
                                
                                                object.setReleaseType(net.proventis.axis.blueant.project.ProjectResourceReleaseType.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","personID").equals(reader.getName())){

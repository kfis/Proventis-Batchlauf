 ...
 */
        ...
        public  class T_Ticket extends net.proventis.axis.blueant.ticket.T_NewTicket
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected double localIsMinutes ;
                           ...
                           * @return double
                           */
                           public  double getIsMinutes(){
                               return localIsMinutes;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param IsMinutes
                               */
                               public void setIsMinutes(double param){
                            
                                            this.localIsMinutes=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       T_Ticket.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/","T_Ticket"));
    ...
    public static class Factory{
        ...
        */
        public static T_Ticket parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            T_Ticket object =
                new T_Ticket();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"T_Ticket".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (T_Ticket)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

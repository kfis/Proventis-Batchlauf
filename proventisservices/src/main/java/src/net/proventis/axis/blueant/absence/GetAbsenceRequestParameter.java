...
/**
 * GetAbsenceRequestParameter.java
 *
 ...
 */
            ...
            /**
            *  GetAbsenceRequestParameter bean class
            */
        
        public  class GetAbsenceRequestParameter
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://absence.blueant.axis.proventis.net/",
                "GetAbsenceRequestParameter",
                "ns7");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for AbsenceState
                        */

                        
                                    protected net.proventis.axis.blueant.absence.T_AbsenceState localAbsenceState ;
                           ...
                           */
                           public  net.proventis.axis.blueant.absence.T_AbsenceState getAbsenceState(){
                               return localAbsenceState;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param AbsenceState
                               */
                               public void setAbsenceState(net.proventis.axis.blueant.absence.T_AbsenceState param){
                            
                                            this.localAbsenceState=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetAbsenceRequestParameter.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetAbsenceRequestParameter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetAbsenceRequestParameter",
                                    ...
                                    if (localAbsenceTypeID==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"absenceTypeID", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"absenceTypeID");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("absenceTypeID");
                                        }
                                    ...
                                    if (localAbsenceState==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"absenceState", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"absenceState");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("absenceState");
                                        }
                                     ...
                                     localAbsenceState.serialize(new javax.xml.namespace.QName("http://absence.blueant.axis.proventis.net/","absenceState"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://absence.blueant.axis.proventis.net/",
                                    ...
                                    elementList.add(localAbsenceTypeID==null?null:
                                    localAbsenceTypeID);
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://absence.blueant.axis.proventis.net/",
                                    ...
                                    elementList.add(localAbsenceState==null?null:
                                    localAbsenceState);
    ...
    public static class Factory{
        ...
        */
        public static GetAbsenceRequestParameter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAbsenceRequestParameter object =
                new GetAbsenceRequestParameter();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetAbsenceRequestParameter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAbsenceRequestParameter)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://absence.blueant.axis.proventis.net/","sessionID").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://absence.blueant.axis.proventis.net/","absenceState").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setAbsenceState(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setAbsenceState(net.proventis.axis.blueant.absence.T_AbsenceState.Factory.parse(reader));

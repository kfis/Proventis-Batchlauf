...
/**
 * GetProjectTasksRequestParameter.java
 *
 ...
 */
            ...
            /**
            *  GetProjectTasksRequestParameter bean class
            */
        
        public  class GetProjectTasksRequestParameter
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://project.blueant.axis.proventis.net/",
                "getProjectTasksRequestParameter",
                "ns8");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected net.proventis.axis.blueant.project.T_TaskStateValue localTaskState ;
                                

                           /**
                           * Auto generated getter method
                           * @return net.proventis.axis.blueant.project.T_TaskStateValue
                           */
                           public  net.proventis.axis.blueant.project.T_TaskStateValue getTaskState(){
                            ...
                            /**
                               ...
                               */
                               public void setTaskState(net.proventis.axis.blueant.project.T_TaskStateValue param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetProjectTasksRequestParameter.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getProjectTasksRequestParameter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getProjectTasksRequestParameter",
                                    ...
                                    if (localTaskState==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"taskState", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"taskState");
                                            }
                                     ...
                                     localTaskState.serialize(new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","taskState"),
                                        factory,xmlWriter);
                                    }
    ...
    public static class Factory{
        ...
        */
        public static GetProjectTasksRequestParameter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetProjectTasksRequestParameter object =
                new GetProjectTasksRequestParameter();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getProjectTasksRequestParameter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetProjectTasksRequestParameter)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","taskState").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setTaskState(net.proventis.axis.blueant.project.T_TaskStateValue.Factory.parse(reader));

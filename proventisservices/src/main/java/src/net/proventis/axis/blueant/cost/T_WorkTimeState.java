 ...
 */
            ...
            /**
            *  T_WorkTimeState bean class
            */
        
        public  class T_WorkTimeState
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = T_WorkTimeState
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected net.proventis.axis.blueant.cost.WorkTimeStateValues localState ;
                                

                           /**
                           * Auto generated getter method
                           * @return net.proventis.axis.blueant.cost.WorkTimeStateValues
                           */
                           public  net.proventis.axis.blueant.cost.WorkTimeStateValues getState(){
                               return localState;
                           }
                            ...
                            /**
                               ...
                               * @param param State
                               */
                               public void setState(net.proventis.axis.blueant.cost.WorkTimeStateValues param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       T_WorkTimeState.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":T_WorkTimeState",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "T_WorkTimeState",
                           xmlWriter);
                                            ...
                                            if (localWorkTimeID==null){
                                                 throw new org.apache.axis2.databinding.ADBException("workTimeID cannot be null!!");
                                            }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://cost.blueant.axis.proventis.net/",
                                    ...
                                    elementList.add(localWorkTimeID);
    ...
    public static class Factory{
        ...
        */
        public static T_WorkTimeState parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            T_WorkTimeState object =
                new T_WorkTimeState();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"T_WorkTimeState".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (T_WorkTimeState)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://cost.blueant.axis.proventis.net/","state").equals(reader.getName())){
                                                ...
                                                object.setState(net.proventis.axis.blueant.cost.WorkTimeStateValues.Factory.parse(reader));

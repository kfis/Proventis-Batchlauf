 ...
 */
            ...
            /**
            *  T_ProjectParticipation bean class
            */
        
        public  class T_ProjectParticipation
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = T_ProjectParticipation
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected net.proventis.axis.blueant.project.ProjectParticipationState localState ;
                                

                           /**
                           * Auto generated getter method
                           * @return net.proventis.axis.blueant.project.ProjectParticipationState
                           */
                           public  net.proventis.axis.blueant.project.ProjectParticipationState getState(){
                               return localState;
                           }
                            ...
                            /**
                               ...
                               * @param param State
                               */
                               public void setState(net.proventis.axis.blueant.project.ProjectParticipationState param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       T_ProjectParticipation.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":T_ProjectParticipation",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "T_ProjectParticipation",
                           xmlWriter);
                   }
                                    ...
                                    if (localProjectParticipationID==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"projectParticipationID", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"projectParticipationID");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("projectParticipationID");
                                        }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localState==null){
                                     ...
                                     localState.serialize(new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","state"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/",
                                    ...
                                    elementList.add(localProjectParticipationID==null?null:
                                    localProjectParticipationID);
    ...
    public static class Factory{
        ...
        */
        public static T_ProjectParticipation parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            T_ProjectParticipation object =
                new T_ProjectParticipation();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"T_ProjectParticipation".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (T_ProjectParticipation)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","projectParticipationID").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setProjectParticipationID(null);
                                          reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","state").equals(reader.getName())){
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setState(net.proventis.axis.blueant.project.ProjectParticipationState.Factory.parse(reader));

 ...
 */
            ...
            /**
            *  T_WtCalendar bean class
            */
        
        public  class T_WtCalendar
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        /**
                        * field for WtCalendarID
                        */

                        
                                    protected net.proventis.axis.blueant.base.Id localWtCalendarID ;
                           ...
                           */
                           public  net.proventis.axis.blueant.base.Id getWtCalendarID(){
                               return localWtCalendarID;
                           }
                            ...
                            /**
                               ...
                               * @param param WtCalendarID
                               */
                               public void setWtCalendarID(net.proventis.axis.blueant.base.Id param){
                            
                                            this.localWtCalendarID=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       T_WtCalendar.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                            ...
                                            if (localWtCalendarID==null){
                                                 throw new org.apache.axis2.databinding.ADBException("wtCalendarID cannot be null!!");
                                            }
                                           localWtCalendarID.serialize(new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","wtCalendarID"),
                                               factory,xmlWriter);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/",
                                    ...
                                    elementList.add(localWtCalendarID);
    ...
    public static class Factory{
        ...
        */
        public static T_WtCalendar parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            T_WtCalendar object =
                new T_WtCalendar();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"T_WtCalendar".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (T_WtCalendar)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","wtCalendarID").equals(reader.getName())){
                                
                                                object.setWtCalendarID(net.proventis.axis.blueant.base.Id.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","duration").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://project.blueant.axis.proventis.net/","default").equals(reader.getName())){

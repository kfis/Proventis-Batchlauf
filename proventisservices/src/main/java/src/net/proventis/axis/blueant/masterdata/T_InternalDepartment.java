 ...
 */
            ...
            /**
            *  T_InternalDepartment bean class
            */
        
        public  class T_InternalDepartment
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = T_InternalDepartment
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected net.proventis.axis.blueant.masterdata.T_InternalDepartmentList localChildren ;
                           ...
                           */
                           public  net.proventis.axis.blueant.masterdata.T_InternalDepartmentList getChildren(){
                            ...
                            /**
                               ...
                               */
                               public void setChildren(net.proventis.axis.blueant.masterdata.T_InternalDepartmentList param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       T_InternalDepartment.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":T_InternalDepartment",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "T_InternalDepartment",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static T_InternalDepartment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            T_InternalDepartment object =
                new T_InternalDepartment();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"T_InternalDepartment".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (T_InternalDepartment)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                      ...
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          ...
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setChildren(net.proventis.axis.blueant.masterdata.T_InternalDepartmentList.Factory.parse(reader));

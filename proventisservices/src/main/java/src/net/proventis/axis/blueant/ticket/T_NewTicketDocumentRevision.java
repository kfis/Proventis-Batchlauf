...
/**
 * T_NewTicketDocumentRevision.java
 *
 ...
 */
            ...
            /**
            *  T_NewTicketDocumentRevision bean class
            */
        
        public  class T_NewTicketDocumentRevision
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = T_NewTicketDocumentRevision
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localDescRev ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getDescRev(){
                               return localDescRev;
                           }
                            ...
                            /**
                               ...
                               * @param param DescRev
                               */
                               public void setDescRev(java.lang.String param){
                            
                                            this.localDescRev=param;
                        ...
                        */
                                    ...
                                    protected net.proventis.axis.blueant.base.Id localEditorID ;
                           ...
                           */
                           public  net.proventis.axis.blueant.base.Id getEditorID(){
                               return localEditorID;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param EditorID
                               */
                               public void setEditorID(net.proventis.axis.blueant.base.Id param){
                            
                                            this.localEditorID=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       T_NewTicketDocumentRevision.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":T_NewTicketDocumentRevision",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "T_NewTicketDocumentRevision",
                           xmlWriter);
                   }
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"descRev", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"descRev");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("descRev");
                                    }
                                

                                          if (localDescRev==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localDescRev);
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                             
                                    if (localEditorID==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"editorID", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"editorID");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("editorID");
                                        }
                                     ...
                                     localEditorID.serialize(new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/","editorID"),
                                        factory,xmlWriter);
                                    }
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(localContent);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/",
                                         ...
                                         elementList.add(localDescRev==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localDescRev));
                                    
                            elementList.add(new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/",
                                                                      "editorID"));
                            
                            
                                    elementList.add(localEditorID==null?null:
                                    localEditorID);
    ...
    public static class Factory{
        ...
        */
        public static T_NewTicketDocumentRevision parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            T_NewTicketDocumentRevision object =
                new T_NewTicketDocumentRevision();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"T_NewTicketDocumentRevision".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (T_NewTicketDocumentRevision)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/","fileName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/","content").equals(reader.getName())){
                                reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/","mimeType").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/","descRev").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/","editorID").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setEditorID(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setEditorID(net.proventis.axis.blueant.base.Id.Factory.parse(reader));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://ticket.blueant.axis.proventis.net/","modified").equals(reader.getName())){

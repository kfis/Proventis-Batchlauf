 ...
 */
            ...
            /**
            *  GetTasksRequestParameter bean class
            */
        
        public  class GetTasksRequestParameter
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://cost.blueant.axis.proventis.net/",
                "getTasksRequestParameter",
                "ns6");
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for SelectedTaskID
                        */

                        
                                    protected net.proventis.axis.blueant.base.Id localSelectedTaskID ;
                           ...
                           * @return net.proventis.axis.blueant.base.Id
                           */
                           public  net.proventis.axis.blueant.base.Id getSelectedTaskID(){
                               return localSelectedTaskID;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param SelectedTaskID
                               */
                               public void setSelectedTaskID(net.proventis.axis.blueant.base.Id param){
                            
                                            this.localSelectedTaskID=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetTasksRequestParameter.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getTasksRequestParameter",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getTasksRequestParameter",
                                    ...
                                    if (localSelectedTaskID==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"selectedTaskID", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"selectedTaskID");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("selectedTaskID");
                                        }
                                     ...
                                     localSelectedTaskID.serialize(new javax.xml.namespace.QName("http://cost.blueant.axis.proventis.net/","selectedTaskID"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://cost.blueant.axis.proventis.net/",
                                    ...
                                    elementList.add(localSelectedTaskID==null?null:
                                    localSelectedTaskID);
    ...
    public static class Factory{
        ...
        */
        public static GetTasksRequestParameter parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTasksRequestParameter object =
                new GetTasksRequestParameter();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getTasksRequestParameter".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTasksRequestParameter)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://cost.blueant.axis.proventis.net/","selectedTaskID").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setSelectedTaskID(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setSelectedTaskID(net.proventis.axis.blueant.base.Id.Factory.parse(reader));

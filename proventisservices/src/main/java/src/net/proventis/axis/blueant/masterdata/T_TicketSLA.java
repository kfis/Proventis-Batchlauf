 ...
 */
            ...
            /**
            *  T_TicketSLA bean class
            */
        
        public  class T_TicketSLA
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       T_TicketSLA.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                           ...
                                           localTicketSLAID.serialize(new javax.xml.namespace.QName("http://masterdata.blueant.axis.proventis.net/","ticketSLAID"),
                                               factory,xmlWriter);
                                    ...
                                    if (localResponsibleID==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"responsibleID", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"responsibleID");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("responsibleID");
                                        }
                                     ...
                                     localResponsibleID.serialize(new javax.xml.namespace.QName("http://masterdata.blueant.axis.proventis.net/","responsibleID"),
                                        factory,xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://masterdata.blueant.axis.proventis.net/",
                                    ...
                                    elementList.add(localResponsibleID==null?null:
                                    localResponsibleID);
    ...
    public static class Factory{
        ...
        */
        public static T_TicketSLA parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            T_TicketSLA object =
                new T_TicketSLA();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"T_TicketSLA".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (T_TicketSLA)net.proventis.axis.blueant.exception.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://masterdata.blueant.axis.proventis.net/","ticketSLAID").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://masterdata.blueant.axis.proventis.net/","responsibleID").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setResponsibleID(null);
                                          reader.next();
